...
export default function Home() {
  ...
  const areas = [
    {
      ...
      description:
        "Desarrollo técnico, disciplina y trabajo en equipo dentro y fuera de la cancha.",
      image: "/assets/images/Home/6.webp",
      link: "/areas-proyectos#nuestras-areas",
    },
    {
      id: 2,
      title: "ACOMPAÑAMIENTO PSICOSOCIAL",
      description:
        "Apoyo profesional que fortalece el bienestar emocional y social.",
    ...
    },
    {
      ...
      description:
        "Hábitos alimenticios saludables para el rendimiento y bienestar.",
      image: "/assets/images/Home/8.webp",
      link: "/areas-proyectos#nuestras-areas",
    },
    {
      id: 4,
      ...
      description:
        "Prevención y cuidado físico mediante fisioterapia para una práctica deportiva segura.",
      image: "/assets/images/Home/9.webp",
      link: "/areas-proyectos#nuestras-areas",
    },
  ];
  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-xl aspect-video bg-gray-900 ring-1 ring-gray-200">
                ...
                >
                  <source
                    src="/assets/images/Home/5.mov"
                    type="video/quicktime"
                  />
                  <source src="/assets/images/Home/5.mov" type="video/mp4" />
                </video>
              </div>
            ...
            >
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed text-lg">
                <p>
                  Tu donación nos permite seguir brindando oportunidades
                  deportivas, educativas y de desarrollo personal a niñas y
                  jóvenes de nuestra fundación.
                </p>
                <p>
                  Cada aporte contribuye directamente a la formación de futuras
                  líderes, fortaleciendo sus habilidades y construyendo un
              ...
              <div className="grid grid-cols-3 gap-4 pt-4">
                <div className="text-center p-4 bg-gray-50 rounded-xl border border-gray-100 hover:border-[#B595FF]/30 transition-colors">
                  <div className="text-2xl font-bold text-[#B595FF] mb-1">
                    +
                  </div>
                ...
                <div className="text-center p-4 bg-gray-50 rounded-xl border border-gray-100 hover:border-[#9BE9FF]/30 transition-colors">
                  <div className="text-2xl font-bold text-[#9BE9FF] mb-1">
                    +
                  </div>
      ...
      <section
        id="impacto"
        className="py-16 px-6 sm:px-10 lg:px-20 bg-gradient-to-b from-white to-gray-50"
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            >
              ...
              <div className="mb-6 flex justify-center relative z-10">
                ...
                >
                  <svg
                    className="w-20 h-20 text-[#B595FF]"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-700 leading-relaxed text-lg max-w-3xl mx-auto">
              Desarrollamos programas que integran deporte, bienestar y
              acompañamiento profesional para potenciar el crecimiento personal
              y deportivo de niñas y jóvenes.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed text-xl max-w-3xl mx-auto">
              Ellas son el corazón de nuestro impacto. Sus historias reflejan el
              poder del acompañamiento, el deporte y las oportunidades.
            </p>
          </motion.div>
            ...
            >
              ...
              <div className="relative overflow-hidden rounded-3xl bg-white shadow-xl hover:shadow-2xl border border-gray-100 group-hover:border-[#B595FF]/30 transition-all duration-500">
                ...
                <div className="relative h-96 overflow-hidden">
                  ...
                  <img
                    src="/assets/images/Home/Maria Antonia.webp"
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="relative bg-white backdrop-blur-md px-5 py-2.5 rounded-full border border-[#B595FF]/20 shadow-lg">
                        <span className="text-sm font-bold text-[#B595FF]">
                          11 años
                        </span>
                      </div>
                    </div>
                ...
                <div className="relative p-8 bg-white">
                  ...
                  <p className="text-gray-600 text-base leading-relaxed">
                    Una historia de superación y dedicación que inspira a toda
                    nuestra comunidad.
                  </p>
                </div>
            ...
            >
              ...
              <div className="relative overflow-hidden rounded-3xl bg-white shadow-xl hover:shadow-2xl border border-gray-100 group-hover:border-[#9BE9FF]/30 transition-all duration-500">
                ...
                <div className="relative h-96 overflow-hidden">
                  ...
                  <img
                    src="/assets/images/Home/Gabi rodriguez.webp"
                    alt="Gaby Rodríguez"
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent z-20" />
                  ...
                  >
                    <div className="relative">
                      ...
                      <div className="relative bg-white backdrop-blur-md px-5 py-2.5 rounded-full border border-[#9BE9FF]/20 shadow-lg">
                        <span className="text-sm font-bold text-[#9BE9FF]">
                          8 años
                        </span>
                      </div>
                    </div>
                ...
                <div className="relative p-8 bg-white">
                  {/* Descripción */}
                  <p className="text-gray-600 text-base leading-relaxed">
                    El deporte como herramienta de transformación y crecimiento
                    personal.
                  </p>
                </div>
            ...
            >
              ...
              <div className="relative overflow-hidden rounded-3xl bg-white shadow-xl hover:shadow-2xl border border-gray-100 group-hover:border-[#B595FF]/30 transition-all duration-500">
                ...
                <div className="relative h-96 overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#B595FF]/10 to-[#9BE9FF]/10 mix-blend-overlay z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  <img
                    src="/assets/images/Home/Sofia alejandra.webp"
                ...
                <div className="relative p-8 bg-white">
                  {/* Descripción */}
                  <p className="text-gray-600 text-base leading-relaxed">
                    Construyendo sueños a través del compromiso y la pasión por
                    el fútbol.
                  </p>
                </div>
