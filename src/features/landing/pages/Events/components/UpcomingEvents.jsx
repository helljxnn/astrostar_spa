// src/pages/Events/components/UpcomingEvents.jsx
...
export const UpcomingEvents = ({ events, eventTypeLabel, onEventClick }) => {
  if (!events || events.length === 0) return null;

  return (
    <div className="mb-20">
      <h3 className="text-3xl font-semibold mb-12 text-gray-700 font-questrial">
        🔜 Próximos {eventTypeLabel}
      </h3>
      <div className="max-w-[85rem] mx-auto">
        <EventsGrid 
          ...
          isPast={false}
          onEventClick={onEventClick}
          emptyMessage={`Pronto tendremos novedades sobre ${eventTypeLabel?.toLowerCase()}`}
        />
      </div>
    </div>
  );
