...
import { FaTimes, FaIdCard, FaEnvelope, FaPhone, FaMapMarkerAlt, FaBirthdayCake, FaUser, FaBriefcase } from "react-icons/fa";
...
const ViewProfileModal = ({ isOpen, onClose, user }) => {
    ...
    return (
        ...
        >
            <motion.div
                className="bg-white rounded-2xl shadow-2xl w-full max-w-6xl max-h-[95vh] overflow-y-auto relative"
            ...
            >
                ...
                <div className="p-4">
                    <div className="flex flex-col items-center mb-4">
                        {user?.avatar ? (
                            <img src={user.avatar} alt="Avatar" className="w-20 h-20 rounded-full object-cover border-4 border-white shadow-lg" />
                        ) : (
                            ...
                            <div className="bg-white border border-gray-200 rounded-xl p-3 shadow-sm">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <DetailItem 
                                        ...
                                        value={user?.middleName || user?.segundoNombre || 'No especificado'} 
                                    />
                                    <DetailItem 
                                        icon={<FaUser size={16} />} 
                                        label="Primer Apellido" 
                                        value={user?.lastName || user?.apellido || 'No especificado'} 
                                    />
                                    <DetailItem 
                                        icon={<FaUser size={16} />} 
                                        label="Segundo Apellido" 
                                        value={user?.secondLastName || user?.segundoApellido || 'No especificado'} 
                                    />
                                    <DetailItem 
                                    ...
                                    <DetailItem 
                                        icon={<FaBirthdayCake size={16} />} 
                                        label="Edad" 
                                        value={user?.age ? `${user.age} años` : calculateAge(user?.birthDate || user?.fechaNacimiento)} 
                                    />
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="bg-white border border-gray-200 rounded-xl p-3 shadow-sm">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <DetailItem 
                                        ...
                                        label="Teléfono" 
                                        value={user?.phoneNumber || user?.telefono || 'No especificado'} 
                                    />
                                    <DetailItem 
                                        icon={<FaMapMarkerAlt size={16} />} 
                                        label="Dirección" 
                                        value={user?.address || user?.direccion || 'No especificado'} 
                                    />
                                </div>
                            </div>
                            ...
                            <div className="bg-white border border-gray-200 rounded-xl p-3 shadow-sm">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <DetailItem 
                                        ...
                                        value={user?.identification || user?.identificacion || 'No especificado'} 
                                    />
                                    <DetailItem 
                ...
                {/* Footer */}
                <div className="flex-shrink-0 border-t border-gray-200 p-3 flex justify-center">
                    <motion.button
                        onClick={onClose}
                        className="px-8 py-2 bg-primary-purple text-white rounded-xl hover:bg-primary-blue transition-colors font-medium shadow-md"
