...
function DynamicSideBar({
  ...
  const visibleModules = {
    ...
    services:
      ...
      hasModuleAccess("employeesSchedule") ||
      hasModuleAccess("appointmentManagement") ||
      hasModuleAccess("classes"),
    // Deportistas - mostrar si tiene acceso a cualquier submódulo
    athletes:
      isAdmin ||
      hasModuleAccess("sportsCategory") ||
      hasModuleAccess("athletesSection") ||
      hasModuleAccess("athletesAssistance"),
    // Donaciones - mostrar si tiene acceso a cualquier submódulo
    donations:
      isAdmin ||
      hasModuleAccess("donorsSponsors") ||
      hasModuleAccess("donationsManagement"),
    // Eventos - mostrar si tiene acceso a cualquier submódulo
    events:
      isAdmin ||
      hasModuleAccess("eventsManagement") ||
      hasModuleAccess("temporaryWorkers") ||
      hasModuleAccess("temporaryTeams"),
    // Compras - mostrar si tiene acceso a cualquier submódulo
    purchases:
      isAdmin ||
      hasModuleAccess("providers") ||
      hasModuleAccess("purchasesManagement"),
    ...
    classes: isAdmin || hasModuleAccess("classes"),
                ...
                >
                  <span className="flex items-center gap-4">
                    <motion.div
                      ...
                      transition={{ duration: 0.2 }}
                    >
                      <FaDonate size={20} className="shrink-0" />
                    </motion.div>
                    <AnimatePresence>
                      {isExpanded && (
                        <motion.span
