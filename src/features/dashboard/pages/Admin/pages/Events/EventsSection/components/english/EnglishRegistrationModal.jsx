...
const EnglishRegistrationModal = ({ isOpen, onClose, onAction, position }) => {
  if (!isOpen) return null;

  const actions = [
    {
      id: "register",
      label: "Inscribir Deportistas",
...
export default EnglishRegistrationModal;