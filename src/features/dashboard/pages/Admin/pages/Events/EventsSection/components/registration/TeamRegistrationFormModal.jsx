                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1 flex-wrap">
                          ...
                          <span className={`px-2 py-0.5 rounded-full text-xs font-semibold flex-shrink-0 ${
                            ...
                            {team.teamType === 'Fundacion' ? 'Fundación' : 'Temporal'}
                          </span>
                          {team.category && (
                        ...
                        <div className="flex items-center gap-3 text-xs text-gray-600">
                          ...
                          <span className="flex-shrink-0">
                            <span className="font-medium">Miembros:</span> <span className="font-semibold text-indigo-600">{team._count?.members || 0}</span>
                          </span>
                        </div>
                      </div>
          ...
          {selectedTeams.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-20">
              ...
              <p className="text-gray-500 text-sm text-center max-w-sm">
                Usa el buscador para encontrar y seleccionar los equipos que deseas inscribir
              </p>
            </div>
          ) : (
            <div>
