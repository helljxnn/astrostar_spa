...
const AthleteModal = ({
  ...
  const {
    ...
    },
    {
      ...
      numeroDocumento: [
        (value) =>
          !value?.trim() ? "El número de documento es obligatorio" : "",
      ],
      correo: [
      ...
      telefono: [
        (value) =>
          !value?.trim() ? "El número telefónico es obligatorio" : "",
      ],
      edad: [
        (value) =>
          !value || isNaN(parseInt(value)) ? "La edad es obligatoria" : "",
        (value) => {
      ...
      categoria: [(value) => (!value ? "Debe seleccionar una categoría" : "")],
