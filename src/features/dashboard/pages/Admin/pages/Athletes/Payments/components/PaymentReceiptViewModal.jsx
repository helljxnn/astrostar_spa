...
import { FaTimes, FaEye, FaFileAlt, FaImage } from "react-icons/fa";
  ...
  const modalContent = (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div
            className="bg-white rounded-2xl shadow-2xl w-full max-w-7xl max-h-[98vh] overflow-hidden relative flex flex-col"
          ...
          >
                ...
                <div className="space-y-4">
                  ...
                  {fileType === 'image' && (
                    <div className="bg-gray-50 rounded-lg p-2 border border-gray-200">
                      <img
                        ...
                        className="w-full h-auto max-h-[80vh] mx-auto rounded-lg shadow-md object-contain cursor-zoom-in"
                  ...
                  <div className="flex justify-center pt-2">
                    <button
                      ...
                      className="flex items-center gap-2 px-6 py-3 bg-primary-purple hover:bg-primary-blue text-white rounded-lg transition-colors font-medium"
                    >
            ...
            <div className="flex-shrink-0 border-t border-gray-200 p-3">
              <div className="flex justify-center">
                <button
                  onClick={onClose}
                  className="px-4 py-2 bg-primary-blue text-white rounded-lg hover:opacity-90 transition font-medium text-sm"
                >
                  Cerrar
                </button>
              </div>
