...
const FormCreate = ({ isOpen, onClose, onSubmit }) => {
    ...
    const handleFormSubmit = (dataFromForm) => {
        ...
        setFormData({
            ...
            Cantidad: "", PrecioUnitario: "", estado: "Pendiente",
        });
    };
