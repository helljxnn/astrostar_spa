...
const FormCreate = ({ isOpen, onClose, onSubmit }) => {
    ...
    return (
        <Form
            isOpen={isOpen}
            title="Registrar Nuevo Patrocinador"
