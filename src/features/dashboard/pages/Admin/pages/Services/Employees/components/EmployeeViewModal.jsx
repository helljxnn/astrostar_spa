...
const EmployeeViewModal = ({
  ...
  const creationDate = employee.createdAt || employee.user?.createdAt;
  const updateDate = employee.updatedAt || employee.user?.updatedAt;
  const statusDate =
    employee.statusAssignedAt ||
    employee.user?.statusAssignedAt ||
  ...
  const modalContent = (
    ...
    >
      ...
      >
        ...
        <div className="modal-body flex-1 overflow-y-auto p-3 relative flex flex-col gap-4">
